...
private:
    ...
    QGroupBox *startup_shutdown_group_box;
    QVBoxLayout *startup_shutdown_vbox;
    QCheckBox *start_fullscreen_checkbox;
    QCheckBox *exit_on_shutdown_checkbox;

    QButtonGroup *special_key_group;
    QGroupBox *special_key_box;
    QRadioButton *special_key_1, *special_key_2, *special_key_3;
    QVBoxLayout *special_key_vbox;
