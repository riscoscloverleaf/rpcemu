...
#define RPCEMU_SPECAIL_KEY_CTRL_END 1
#define RPCEMU_SPECAIL_KEY_CTRL_ALT_ENTER 2
#define RPCEMU_SPECAIL_KEY_ALT_END 3
...
public:
    ...
    void rpcemu_set_host_clipboard(char *text);
